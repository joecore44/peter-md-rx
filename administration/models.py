...
class MedicationOrder(models.Model):
    ...
    semaglutide_l1 = models.BooleanField(default=False)
    semaglutide_l2 = models.BooleanField(default=False)
    ...
    phentermine = models.BooleanField(default=False)
    ...
    cabergoline = models.BooleanField(default=False)
    ...
    modafanil = models.BooleanField(default=False)
